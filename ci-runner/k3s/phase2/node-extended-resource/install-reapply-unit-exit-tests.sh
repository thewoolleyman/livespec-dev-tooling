...
# presence probe is a read, and a read is performed under --dry-run on purpose
# so the removal sequence a dry run prints is the one this host actually needs.
# What must be absent is every MUTATION.
# ---------------------------------------------------------------------------
