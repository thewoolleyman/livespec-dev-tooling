...
# value installed live is 32 as of 2026-09-02 -- an INTERIM throttle (maintainer
# decision, livespec plan ci-runner-pod-lifecycle-reliability / epic
# livespec-ifwnqj) until the NVMe tiering livespec-e2vcqf lifts the RAID's
# data-plane ceiling, after which it returns to 64 (the increase-ci-runners
# raise of 2026-08-30, livespec epic livespec-zec4mz; it was 16 from
# livespec-s43svm.26 until then). 482 was never adopted for this pool — see
# README.md "Why per-repo quotas summing above 482 is safe",
# ../kueue/DERIVATION.md "The derivation at C = 32 (2026-09-02, INTERIM ...)"
# and "The derivation at C = 64 (2026-08-30)", and ../VALIDATION_CHECKLIST.md.
set -euo pipefail

USAGE="usage: patch-node-churn-capacity.sh CAPACITY (the host's churn-slot capacity; 32 is the value installed live as of 2026-09-02 -- an interim throttle, 64 before it -- and the podman-era 482 was never adopted -- see this script's own header comment and ../kueue/DERIVATION.md)"
CAPACITY="${1:?$USAGE}"
