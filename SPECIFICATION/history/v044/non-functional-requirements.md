...
budget. Its safe startup batch is at most 450 of GitHub's documented
...
each, or ten points per pair. After the
initial batch it MUST admit only budget-accounted refill work. Unknown,
...
Each repository's logical ceiling MUST be doubled to support two concurrent
matrix pipelines. The physical host-wide cap remains exactly 482 active
