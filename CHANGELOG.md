...
* report served plugin build currency ([12ab9c6](https://github.com/thewoolleyman/livespec-dev-tooling/commit/12ab9c6a7e916fd58a0bac5d6c0d01341448497e))

## [1.89.3](https://github.com/thewoolleyman/livespec-dev-tooling/compare/v1.89.2...v1.89.3) (2026-09-12)


### Bug Fixes

* **fleet:** attempt every planned plugin command past a refusal ([5751ae9](https://github.com/thewoolleyman/livespec-dev-tooling/commit/5751ae9a950c57f6bc1704040f6db6e3d40ff42f))
...
* route the enforcement suite's GitHub reads through the budgeted client ([e6680d1](https://github.com/thewoolleyman/livespec-dev-tooling/commit/e6680d1736d3797399ae6011d784dc7e1613b085))
...
* **fabro-sandbox:** require explicit Git author ([483ae52](https://github.com/thewoolleyman/livespec-dev-tooling/commit/483ae527f3dbab0d56787963559ecf3a2d87a7e5))

## [1.85.2](https://github.com/thewoolleyman/livespec-dev-tooling/compare/v1.85.1...v1.85.2) (2026-09-10)


### Bug Fixes

* **ci-runner-k3s:** make the agent-rejoin watchdog detect the real wedge ([e7060e4](https://github.com/thewoolleyman/livespec-dev-tooling/commit/e7060e4737aba8b92b9ed921d22bdc545a0ccd3d))
...
* **fleet:** take the manifest read off the REST rate-limit path ([f3a022d](https://github.com/thewoolleyman/livespec-dev-tooling/commit/f3a022d059b0052a2b65dbdf0a71fad5093fb421))

## [1.83.6](https://github.com/thewoolleyman/livespec-dev-tooling/compare/v1.83.5...v1.83.6) (2026-09-09)


### Bug Fixes

* **checks:** put the config-load supervisor helpers on the IOResult railway ([0aff76a](https://github.com/thewoolleyman/livespec-dev-tooling/commit/0aff76a1bebacffe8d83e5e16ee587f8a6722de5))
...
* **role-key-gate:** separate the declared-absent announcement from the role accessors ([41965c6](https://github.com/thewoolleyman/livespec-dev-tooling/commit/41965c6b21093f00a049a253dc4ea0fdaf9a0c28))

## [1.83.3](https://github.com/thewoolleyman/livespec-dev-tooling/compare/v1.83.2...v1.83.3) (2026-09-09)


### Bug Fixes

* **fleet:** put the cross-member consumption measurement on the Result railway ([426ca99](https://github.com/thewoolleyman/livespec-dev-tooling/commit/426ca99f7a745584ec7fa21216581edca3e111f3))
...
* **fleet:** put the plugin enablement parse on the Result railway ([a1b5e18](https://github.com/thewoolleyman/livespec-dev-tooling/commit/a1b5e18b900105a628c724abbdba6e126bce1a52))
...
* **checks:** guard livespec-family marketplace refs to release ([d9aafa5](https://github.com/thewoolleyman/livespec-dev-tooling/commit/d9aafa5cdd5b1fe7ebe2a6dc79b38dd87c9af4d1))
...
* **checks:** put _work_item_liveness public functions on the Result railway ([7d0bb97](https://github.com/thewoolleyman/livespec-dev-tooling/commit/7d0bb97edb2e7deb7b67c591e05ed1864b7681f7))


### Bug Fixes

* **release-guard:** put the four shipped-path guard IO seams on the railway ([6483c4c](https://github.com/thewoolleyman/livespec-dev-tooling/commit/6483c4cc62586dc89dee2b49b2173f72f04e4b5b))
...
* **ansible:** gha_runner role — the self-hosted runner that serves livespec-orchestrator ([054e23e](https://github.com/thewoolleyman/livespec-dev-tooling/commit/054e23ef62fe2e005f69f9222eab52e4db6a2760))
...
* **hooks:** resolve the stop guard's PR by the pushed branch (livespec-dev-tooling-i655) ([48e45a4](https://github.com/thewoolleyman/livespec-dev-tooling/commit/48e45a44dff4dcefa69449e636636253bc040aba))
...
* **release-guard:** runnable commit-scoped shipped-path release guard ([5c84c8c](https://github.com/thewoolleyman/livespec-dev-tooling/commit/5c84c8c978497efdef2032816382090b8369d984))

## [1.65.0](https://github.com/thewoolleyman/livespec-dev-tooling/compare/v1.64.2...v1.65.0) (2026-09-08)


### Features

* **release-guard:** pure decision core for the shipped-path release guard ([d6c7522](https://github.com/thewoolleyman/livespec-dev-tooling/commit/d6c7522a7e234965b26522b715aaa9fbc072910a))

## [1.64.2](https://github.com/thewoolleyman/livespec-dev-tooling/compare/v1.64.1...v1.64.2) (2026-09-08)


### Bug Fixes

* render ConfigParseError as a structured diagnostic in every check supervisor ([0c2063a](https://github.com/thewoolleyman/livespec-dev-tooling/commit/0c2063a1d3d5c8c4f579b68c4abebb878f819710))
...
* **cross-repo:** move the lane-watch runner into the package and test it ([8dc9707](https://github.com/thewoolleyman/livespec-dev-tooling/commit/8dc9707d9367a7b6a2f1716a6274960ac5d04070))
...
* **shell-quality:** make the shellcheck failure track total ([f9c796f](https://github.com/thewoolleyman/livespec-dev-tooling/commit/f9c796ff5ff6148ca61640327ef5b6e9b8f3a7cf))
...
* **bump-pin:** reset a leftover bump branch instead of dying on non-fast-forward ([9e5a1ea](https://github.com/thewoolleyman/livespec-dev-tooling/commit/9e5a1ea118efecfca0fbba253cd5f84de8d3b8eb))

## [1.56.1](https://github.com/thewoolleyman/livespec-dev-tooling/compare/v1.56.0...v1.56.1) (2026-09-07)


### Bug Fixes

* **fleet:** escalate a stale pin whose bump PR never opened ([33e1ca9](https://github.com/thewoolleyman/livespec-dev-tooling/commit/33e1ca92214ea7462a590077fa6356f3297b81a1))
...
* **heading_coverage:** stop failing on an unresolvable registry node id ([a5ddd1e](https://github.com/thewoolleyman/livespec-dev-tooling/commit/a5ddd1e2c8e05a126b0bb64724dcb5a258d440ff))
...
* **checks:** cite clause 0's private-helper source by its owning repo ([0fa86de](https://github.com/thewoolleyman/livespec-dev-tooling/commit/0fa86de002d65f456bc1821bf087acbe87bb738e))
...
* **public_api_result_typed:** scan _-prefixed FILES, disqualify only _-prefixed NAMES ([a1d4ed7](https://github.com/thewoolleyman/livespec-dev-tooling/commit/a1d4ed72f7d30e75acd0c43b7393c3c0c826b4bc))
...
* **bootstrap:** stop dirtying tracked .livespec.jsonc at pack install (livespec-dev-tooling-7ix8) ([b80caff](https://github.com/thewoolleyman/livespec-dev-tooling/commit/b80caff183a3ca06138eaafc6a68914e419f1689))
* **checks:** check-coverage-incremental refuses a diff it could not read ([36a48fb](https://github.com/thewoolleyman/livespec-dev-tooling/commit/36a48fbaf454efbc0020818d65d09a050396ca8a))
...
* **hooks:** restate each failed check's failure mode and remedy at the tail of the aggregate ([4812a44](https://github.com/thewoolleyman/livespec-dev-tooling/commit/4812a4458717917af0b5c610af61ff0dd81949a4))
...
* **fabro-sandbox:** sccache-or-rustc probes with a synthetic compile under its own lock, never the caller's request (livespec-console-beads-fabro-di6fn5) ([de6ed0d](https://github.com/thewoolleyman/livespec-dev-tooling/commit/de6ed0dfacfa0d760af1290cb7968cee40ab12cd))
...
* **gate:** scan /proc/*/fd for config holders with one find, not one readlink fork per descriptor ([89b10b5](https://github.com/thewoolleyman/livespec-dev-tooling/commit/89b10b5ba8e1f098d422707549e1b26163f90746))
