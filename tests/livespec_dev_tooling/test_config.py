...
def test_is_generated_recognizes_c_family_block_comment(*, tmp_path: Path) -> None:
    """A single-line `/* @generated */` block comment counts for a C-family extension (`.c`)."""
    target = tmp_path / "gen.c"
    _ = target.write_text("/* @generated by tool */\nint main(){return 0;}\n", encoding="utf-8")
    assert is_generated(path=target) is True


def test_is_generated_recognizes_html_block_comment(*, tmp_path: Path) -> None:
    """A `<!-- @generated -->` block comment counts for `.md`/`.html`."""
