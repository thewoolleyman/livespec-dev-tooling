...
from livespec_dev_tooling.checks._io_boundary_verbs import (
    unresolved_receiver_call_is_io,
)
...
def _attribute_call(
    *,
    ...
    return CallOutcome(
        edges=frozenset(),
        disqualifies=unresolved_receiver_call_is_io(call=call, verb=target.attr),
    )
